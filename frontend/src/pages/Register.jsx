...
const Register = () => {
    ...
    return (
        <div className="min-h-[calc(100vh-56px)] flex items-center justify-center bg-gradient-to-br from-railway-surface to-gray-100 py-8 px-4">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <User size={14} className="absolute left-3 top-2.5 text-gray-300" />
                                    <input
                                        type="text"
                                        required
                                        className="w-full pl-9 pr-3 py-2 border border-gray-200 rounded-lg text-sm font-medium text-railway-dark placeholder:text-gray-300 focus:border-railway-primary focus:ring-1 focus:ring-railway-primary outline-none transition-all"
